...
eval "verif-author.pl $logOpt -p $scoresDir -d tests/data/pan14.impostors tests/009-GI-by-occurrence.conf tests/data/english-20-cases/EN001/known01.txt tests/data/english-20-cases/EN001/unknown.txt"
