...
eval "verif-author.pl -i rw $logOpt -p $scoresDir -d tests/data/pan14.impostors tests/004-GI.conf tests/data/english-20-cases/EN001/known01.txt tests/data/english-20-cases/EN001/unknown.txt"
